...
class CGV_API holo_view_interactor_baseline : 
...
protected:
	...
	unsigned nr_render_views = 3; // --NOTE-- the baseline approach where the scene is rendered fully only in stereo would set this to 2
...
protected:
  ...
  cgv::render::texture quilt_render_tex, quilt_holo_tex, quilt_depth_tex;
	...
	cgv::render::shader_program baseline_shader;
...
public:
	///
  holo_view_interactor_baseline(const char* name);
...
extern CGV_API cgv::reflect::enum_reflection_traits<holo_view_interactor_baseline::MultiplexMode>
